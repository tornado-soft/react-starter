...
declare global {
  ...
  const BaseHeader: (typeof import('../components/index'))['BaseHeader']
  const BaseLayout: (typeof import('../layouts/index'))['BaseLayout']
  ...
  const NProgressProvider: (typeof import('../providers/index'))['NProgressProvider']
  const NavLink: (typeof import('react-router-dom'))['NavLink']
  const Navigate: (typeof import('react-router-dom'))['Navigate']
  const Outlet: (typeof import('react-router-dom'))['Outlet']
  const Route: (typeof import('react-router-dom'))['Route']
  const Routes: (typeof import('react-router-dom'))['Routes']
  const SITE_META_DATA: (typeof import('../config/index'))['SITE_META_DATA']
